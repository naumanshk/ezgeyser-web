                        ...
                        <Container>
                            ...
                            <div className="center">
                                ...
                                <div className="login-container" >
                                    ...
                                    <p style={{ paddingTop: '20px'  }} className='small-text-login' >Already have an account?<Link to='/login' style={{textDecoration:'none'}}><p className='main-color'>Login</p></Link></p>
